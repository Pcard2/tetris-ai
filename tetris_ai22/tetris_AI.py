...
class TetrisGameAI():
    ...
    def __init__(self):
        ...
        self.width, self.height = 288,338
        ...
        self.xg, self.yg = 10, 20
        self.createGrid(self.xg, self.yg)
        ...
        self.currentShape, self.xp, self.yp, self.shapeChar= self.newShape()
    ...
    def scoring(self):
        ...
        if self.linesCleared > 0:
            ...
            match self.linesCleared:
                case 1: # Single
                    if self.shapeChar == "T" and self.collisionShape(self.grid, self.currentShape, self.currentRotation, self.xp, self.yp-1):
    ...
    def drawShape(self, x, y):
        shape = self.currentShape[self.currentRotation]
    ...
    def step(self):
        ...
        if self.changePiece:
            ...
            self.currentShape, self.shapeChar = self.nextShape, self.nextShapeChar
